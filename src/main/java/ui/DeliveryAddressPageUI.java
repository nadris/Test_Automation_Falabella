...
public class DeliveryAddressPageUI {
    ...
    public static By departmentNumberInput = By.id("departmentNumber");
    public static By enterAddressButton = By.className("fbra_button fbra_test_button fbra_formItem__useAddress");
